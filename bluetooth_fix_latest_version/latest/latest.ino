...
#define SSID "VRADA_TEFAA_1" // name of the wifi access point
#define PASSWORD "VRADA2021" // password of the wifi access point
...
static std::string PredefinedReceivers[] = {"2c:26:17:e9:a0:31"};
static std::string deviceNames[] = {"TOORX 0001"};
