...
static std::string PredefinedTOORXAddresses[] = {"e8:5d:86:03:8b:29"};
static std::string PredefinedReceivers[] = {"2c:26:17:0f:0b:6a"};
static std::string deviceNames[] = {"TOORXRIGHT"};
