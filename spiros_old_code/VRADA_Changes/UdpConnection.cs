/*
*   Code from MattijsKneppers, user of Unity forums 
*   Profile link: https://forum.unity.com/members/mattijskneppers.650094/
*   Code link: https://forum.unity.com/threads/simple-udp-implementation-send-read-via-mono-c.15900/
*/
...
public class UdpConnection
{
    ...
    {
        try { udpClient = new UdpClient(receivePort); udpClient.EnableBroadcast = true; }
        catch (Exception e)
        {
