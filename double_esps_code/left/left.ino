...
static std::string PredefinedTOORXAddresses[] = {"00:0c:bf:2e:ea:ed"};
static std::string PredefinedReceivers[] = {"2c:26:17:1a:00:d9"};
static std::string deviceNames[] = {"TOORXLEFT"};
